...
export default function CorredoresSemanal() {
  const { available, top3, prizes, weekRange, isLoading } = useRankingCorredores();
    ...
    <div className="relative">
      <div className="max-w-full relative z-10">
        ...
        {isLoading ? (
          ...
          <div className="mb-8">
            <GlowCard className="p-12 text-center">
              <Target className="w-16 h-16 text-[#19E0FF]/40 mx-auto mb-4" />
              ...
              <p className="text-[#A9B2C7]/60 text-sm mt-2">
                {!available ? 'Rankings serão exibidos quando houver dados reais disponíveis' : 'Os primeiros corredores aparecerão aqui em breve'}
              </p>
            </GlowCard>
          </div>
        ) : (
            ...
            {top3.map((player, idx) => (
              ...
              >
                ...
                >
                  ...
                  <h4 className="text-xl font-bold text-white mb-1">{player.player_name}</h4>
                  <p className="text-[#F7CE46] text-sm mb-4">{player.guild}</p>
                  <div className="flex justify-around text-center">
                    <div>
                      <p className="text-[#A9B2C7] text-xs">DGs</p>
                      <p className="text-[#19E0FF] font-bold">{player.dgs_counted}</p>
                    </div>
                    <div>
                      <p className="text-[#A9B2C7] text-xs">Pontos</p>
        ...
        <div className="text-center">
          <Link to={createPageUrl('RankingCorredores')}>
            <motion.button
