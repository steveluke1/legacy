...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`[marketBridgeDiagnostics:${correlationId}] COMPLETE status=${report.overall_status}`);
    ...
    console.error(`[marketBridgeDiagnostics:${correlationId}] CRITICAL_ERROR: ${error.message}`);
