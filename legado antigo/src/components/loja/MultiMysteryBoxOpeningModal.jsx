...
export default function MultiMysteryBoxOpeningModal({ quantity, onClose }) {
  ...
  const openMutation = useMutation({
    ...
    onError: (error) => {
      console.error('Error opening multiple mystery boxes:', error);
      ...
      <div className="relative w-full max-w-6xl my-8">
        ...
        {stage === 'opening' && (
          <motion.div className="flex flex-col items-center">
            ...
            >
              Abrindo {quantity} caixas misteriosas...
            </motion.p>
          </motion.div>
        )}
